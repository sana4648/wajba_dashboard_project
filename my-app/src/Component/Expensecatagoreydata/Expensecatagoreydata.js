  ...
  const handleAddCategory = () => {
    if (expenseCategory.trim() !== "") {
      if (categories.includes(expenseCategory)) {
        ...
        //     {
        //       category_name: foodData.name,
        //       menu_price: foodData.price,
        //       menu_image: foodData.image,
        //       menu_description: foodData.description,
        //       category_name: foodData.category,
        //       time_preparation: foodData.time,
        //     },
        //     {
        //       headers: {
            ...
            <div>
              ...
              {selectedCategory && (
                <div>
                  ...
                  {/* You can use 'selectedCategory' in other parts of your component */}
                </div>
              )}
            </div>
          </div>
