...
export default function Admin() {
  ...
  const onSubmit = async (values, { setSubmitting }) => {
    ...
    console.log(values);
    try {
        // Simulate an API request delay (remove this in a real implementation)
        await new Promise((resolve) => setTimeout(resolve, 1000));

        // Replace this with your logic to save the data (e.g., make an API request)
  ...
  return (
    <div>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div>
          <label htmlFor="firstName" className='settinglabel'>First Name</label>
          <input
        ...
        <div>
          <label htmlFor="lastName" className='settinglabel'> Last Name</label>
          <input
          className='settinginput'
            type="text"
            id="lastName"
        ...
        <div>
          <label htmlFor="email" className='settinglabel'>Email</label>
          <input
          className='settinginput'
            type="email"
            id="email"
        ...
        <div>
          <label htmlFor="password" className='settinglabel'>Password</label>
          <input
           className='settinginput'
            type="password"
            id="password"
        ...
        <div>
          <label htmlFor="about" className='settinglabel'>About</label>
          <textarea
            id="about"
            name="about"
            onChange={formik.handleChange}
        ...
        <div>
          <label htmlFor="profileImage" className='settinglabel'>Profile Image</label>
          <input
           className='settinginput'
            type="file"
            id="profileImage"
