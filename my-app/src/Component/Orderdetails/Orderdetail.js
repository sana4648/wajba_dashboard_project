...
// const OrderDetails = () => {
//     const [log] = useState([]); // Initialize log with an empty array
...
//         orderStatus: 'Pending', // You can change this value as needed
//         billingDate: 'September 10, 2023', // You can change this date as needed
//     };
...
//                     <p>{invoiceInfo.mobileNumber}</p>
//                 </div>
//                 <div>
//                     <strong>Order Status:</strong>
//                     <p>{invoiceInfo.orderStatus}</p>
//                 </div>
//                 <div>
//                     <strong>Billing Date:</strong>
//                     <p>{invoiceInfo.billingDate}</p>
//                 </div>
//             </div>
