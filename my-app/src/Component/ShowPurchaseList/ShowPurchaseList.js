...
const generateRandomData = () => {
  // Generates random purchase data for demonstration
  const randomData = [];
  for (let i = 1; i <= 10; i++) {
    randomData.push({
      serialNumber: `SN-${i}`,
...
export default function Admin() {
  ...
  const [purchases, setPurchases] = useState(generateRandomData());
