...
export default function Admin() {
  ...
  <div className="profile-details">
    <p className="profile-description">
      This is your user profile page. It displays your account information.
    </p>
    <div className="profile-item">
      <strong>Email:</strong> {userData.email}
    </div>
    <div className="profile-item">
      <strong>Password:</strong> ******** {/* You should never display passwords */}
    </div>
    <div className="profile-item">
      <strong>Last Login:</strong> {userData.lastLogin}
    </div>
    <div className="profile-item">
      <strong>Last Logout:</strong> {userData.lastLogout}
    </div>
  </div>
</div>
